...
## Introduction
This is an official pytorch implementation of mypaper. I just find my idea is amost same as the paper(Bottom-Up Human Pose Estimation Via Disentangled Keypoint Regression). But I did this job earlier.(lol) </br> 
